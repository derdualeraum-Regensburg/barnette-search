...
\label{eq:exception-requirements}
 ...
 (\ell_A(0,1),\ell_A(0,0)).
\end{equation}
The incidence recurrence in \cref{thm:cycle-formula} shows directly that the
...
\[
 ...
 =\frac{(a+2)(b+2)-1}{2}.
\]
The packing half of \cref{lem:certificate-principle} proves the claim.
\end{proof}
...
\cref{prop:signature-antichain,eq:symbolic-family-size}.
\end{proof}
...
\begin{proof}
The lower bound is \cref{thm:packing-lift}; the upper bound is
\cref{thm:separating-family}.  Their cardinalities agree.
\end{proof}
