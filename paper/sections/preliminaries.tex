...
This gives the usual Sperner-type counting obstruction.  The computation also
records a stronger incidence/LYM bound that uses cubicity,
\(|E(G)|=3|V(G)|/2\), and the fact that every Hamiltonian cycle has exactly
\(|V(G)|\) edges.  These general bounds are kept separate from graph-specific
